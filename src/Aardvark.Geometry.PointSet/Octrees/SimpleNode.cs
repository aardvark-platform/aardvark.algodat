...
//        /// <summary></summary>
//        public SimpleNode WithData(ImmutableDictionary<Durable.Def, object> data)
//            => new SimpleNode(this) { Data = data };

//        /// <summary></summary>
//        public SimpleNode AddData(Durable.Def what, Guid key, object value)
...
//        /// <summary></summary>
//        public ImmutableDictionary<Durable.Def, object> Data { get; private set; }
...
//        /// <summary></summary>
//        public float PointDistanceAverage => (float)Data[Durable.Octree.AveragePointDistance];

//        /// <summary></summary>
//        public float PointDistanceStandardDeviation => (float)Data[Durable.Octree.AveragePointDistanceStdDev];
