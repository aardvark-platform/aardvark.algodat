...
//            var buffer = DurableCodec.EncodeDurable(Durable.Octree.TreeMinMaxDepth, x);

//            var (def1, y1) = DurableCodec.DecodeDurable<Range1i>(buffer);
//            Assert.IsTrue(def1 == Durable.Octree.TreeMinMaxDepth);
//            Assert.IsTrue(x == y1);

//            var (def2, y2) = DurableCodec.DecodeDurable(buffer);
//            Assert.IsTrue(def2 == Durable.Octree.TreeMinMaxDepth);
