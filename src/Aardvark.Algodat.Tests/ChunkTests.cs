...
namespace Aardvark.Geometry.Tests
{
    ...
    public class ChunkTests
    {
        ...
        {
            var x = new Chunk(Array.Empty<V3d>(), Array.Empty<C4b>(), null, null, null, null, null, null, null);
            Assert.IsTrue(x.IsEmpty);
            Assert.IsTrue(x.HasPositions);
            Assert.IsTrue(x.HasColors);
        }
        ...
        {
            var x = new Chunk(new V3d[1], new C4b[1], null, null, null, null, null, null, null);
            Assert.IsTrue(x.Count == 1);
            Assert.IsTrue(x.HasPositions);
            Assert.IsTrue(x.HasColors);
        }
        ...
        public void Chunk_MismatchingNumberOfColorsDoesNotFail1()
        {
            Assert.DoesNotThrow(() =>
            {
                var chunk = new Chunk(new[] { new V3d(1, 2, 3), new V3d(4, 5, 6) }, Array.Empty<C4b>(), null, null, null, null, null, null, null);
        ...
        public void Chunk_MismatchingNumberOfColorsDoesNotFail2()
        {
            Assert.DoesNotThrow(() =>
            {
                var chunk = new Chunk(new[] { new V3d(1, 2, 3), new V3d(4, 5, 6) }, new C4b[123], null, null, null, null, null, null, null);
        ...
        public void Chunk_MismatchingNumberOfColorsFails3()
        {
            Assert.Catch(() =>
            {
                new Chunk(null, new C4b[123],null, null, null, null, null, null, null);
            });
        }
        ...
        public void Chunk_EmptyPositionsButNonEmptyColorsFails()
        {
            Assert.Catch(() =>
            {
                new Chunk(null, new C4b[1], null, null, null, null, null, null, null);
            });
        }
        ...
        public void Chunk_ImmutableFilterMinDistByCell_Parts()
        {
            var a = new Chunk(
                ...
                partIndices: new byte[] { 0, 1, 2, 3 }, partIndexRange: null, partIndexSet: null,
                bbox: null
                );
