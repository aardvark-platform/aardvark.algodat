...
namespace Aardvark.Geometry.Tests
{
    ...
    public class MergeTests
    {
        ...
        public void CanMergePointSets_0()
        {
            ...
            var pointset1 = PointSet.Create(storage, "test1", ps1, cs1, ns1, is1, ks1, splitLimit, CancellationToken.None);
            ...
            var pointset2 = PointSet.Create(storage, "test2", ps2, cs2, ns2, is2, ks2, splitLimit, CancellationToken.None);
        ...
        public void CanMergePointSets()
        {
            ...
            var pointset1 = PointSet.Create(storage, "test1", ps1, cs1, ns1, is1, ks1, 1000, CancellationToken.None);
            ...
            var pointset2 = PointSet.Create(storage, "test2", ps2, cs2, ns2, is2, ks2, 1000, CancellationToken.None);
        ...
        public void CanMergePointSets_WithoutColors()
        {
            ...
            var is1 = ps1.Map(_ => 123);
            var ks1 = ps1.Map(_ => (byte)42);
            var pointset1 = PointSet.Create(storage, "test1", ps1, null, ns1, is1, ks1, 1000, CancellationToken.None);

            var ps2 = new V3d[42000].SetByIndex(_ => new V3d(r.NextDouble() + 0.3, r.NextDouble() + 0.3, r.NextDouble() + 0.3));
            var ns2 = ps2.Map(_ => V3f.XAxis);
            var is2 = ps2.Map(_ => 456);
            var ks2 = ps1.Map(_ => (byte)7);
            var pointset2 = PointSet.Create(storage, "test2", ps2, null, ns2, is2, ks2, 1000, CancellationToken.None);
        ...
        public void CanMergePointSets_WithoutNormals()
        {
            ...
            var is1 = ps1.Map(_ => 123);
            var ks1 = ps1.Map(_ => (byte)42);
            var pointset1 = PointSet.Create(storage, "test1", ps1, cs1, null, is1, ks1, 1000, CancellationToken.None);

            var ps2 = new V3d[42000].SetByIndex(_ => new V3d(r.NextDouble() + 0.3, r.NextDouble() + 0.3, r.NextDouble() + 0.3));
            var cs2 = ps2.Map(_ => C4b.White);
            var is2 = ps2.Map(_ => 456);
            var ks2 = ps2.Map(_ => (byte)7);
            var pointset2 = PointSet.Create(storage, "test2", ps2, cs2, null, is2, ks2, 1000, CancellationToken.None);
