...
namespace Aardvark.Geometry.Tests
{
    ...
    public class QueryTests
    {
        ...
        private static PointSet _CreateRandomPointSetForOctreeLevelTests()
        {
            ...
            return PointSet
                .Create(storage, "test", ps.ToList(), cs.ToList(), null, 100, CancellationToken.None)
                .GenerateLod(config)
                ;
        }
        ...
        public void CanQueryPointsWithEverythingInside_Single()
        {
            ...
            var root = InMemoryPointSet.Build(ps, null, null, Cell.Unit, 1).ToPointSetCell(storage, ct: CancellationToken.None);
